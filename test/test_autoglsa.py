...
@pytest.mark.parametrize(
    'a,expected',
    [
        pytest.param(['<www-client/firefox{-bin,}-{91.6.1,97.0.2}: code execution and sandbox escape (actively exploited)',
        ...
        pytest.param(['<www-servers/apache-2.4.52: multiple vulnerabilities',
